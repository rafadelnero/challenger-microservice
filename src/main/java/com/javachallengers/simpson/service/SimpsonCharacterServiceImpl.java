...
@Service
public class SimpsonCharacterServiceImpl implements SimpsonCharacterService {
	private SimpsonCharacterRepository simpsonCharacterRepository;
	
	@Autowired
	public SimpsonCharacterServiceImpl(SimpsonCharacterRepository simpsonCharacterRepository) {
		super();
